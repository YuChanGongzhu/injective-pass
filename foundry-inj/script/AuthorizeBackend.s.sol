...
contract AuthorizeBackendScript is Script {
    // 合约地址
    address constant CAT_NFT_ADDRESS = 0x10fd6cC8d9272caC010224A93e1FA00Ce291E6D8;
    
    // 后端钱包地址（需要授权的地址）
    address constant BACKEND_ADDRESS = 0x1dd50ffF32Ecde6694e56C5bBfE902Fcbc8d2441;
